...
```
flex Lexer.l
g++ lex.yy.c Token.cpp -o lexer -lfl
./lexer file.c
```
...
Not implemented: `_Bool` `_Complex` `_Imaginary` `_Alignas` `_Alignof`
...
- `test5_errors.c` — unknown symbols, multi-char literal, unterminated char/string/comment
